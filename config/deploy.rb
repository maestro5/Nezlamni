...
set :repo_url, 'https://github.com/maestro5/Nezlamni.git'
...
namespace :deploy do
  ...
  task :setup do
    on roles(:all) do
      ...
      upload!('shared/local_env.yml', "#{shared_path}/config/local_env.yml")
  ...
  task :symlink do
    on roles(:all) do
      ...
      execute "ln -s #{shared_path}/config/local_env.yml #{release_path}/config/local_env.yml"
